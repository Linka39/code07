package com.linka39.code07.ZHConverterUtil;

import com.linka39.code07.sensitiveUtil.BCConvertUtils;
...
public class ZHConverter {
	...
	public String convertOver(String in) {
		StringBuilder outString = new StringBuilder();
		StringBuilder stackString = new StringBuilder();
		...
		for (int i = 0; i < in.length(); i++) {
			...
			char c = in.charAt(i);
			c = BCConvertUtils.charConvertOver(c);
			String key = "" + c;
			stackString.append(key);
